...
const SignUp: React.FC = () => {
  ...
  const handleSignup = async (e: FormEvent): Promise<void> => {
    ...
    try {
      const response = await axios.post<{ message: string; token: string; state: string }>(
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full border-stroke xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mt-8 mx-4 mb-4 text-2xl font-bold text-black sm:text-title-xl2">
                サインアップ
              </h2>
              ...
              <form>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      type="email"
                      placeholder="メールアドレス（coutomer@gmail.com）"
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none"
                      value={email}
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="アカウント作成"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 transition hover:bg-gray-100"
