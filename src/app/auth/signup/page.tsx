...
const SignUp: React.FC = () => {
  ...
  const handleSignup = async (e: FormEvent): Promise<void> => {
    ...
    // try {
      const response = await axios.post<{ message: string; token: string }>(
        `${process.env.NEXT_PUBLIC_API_URL}/api/auth/signup`, // Ensure the protocol is included
        {
          name,
          email,
          password,
  ...
  return (
    <div className="mx-auto h-screen mt-8 w-max-w-screen-2xl p-4 md:p-6 2xl:p-10 lg:mt-16">
      <div className="rounded-sm border shadow-default border-strokedark bg-slate-900">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none text-white"
                      value={name}
